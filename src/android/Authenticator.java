...
public class Authenticator extends AbstractAccountAuthenticator
{
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response, String accountType, String authTokenType, String[] requiredFeatures, Bundle options)
    {
		...
		final Intent launchIntent = ctx.getPackageManager().getLaunchIntentForPackage("io.timewatson.com");
        final Bundle bundle = new Bundle();
        bundle.putParcelable(AccountManager.KEY_INTENT, launchIntent);
        return bundle;
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle loginOptions) throws NetworkErrorException
    {
        ...
        if (password != null)
        {
            ...
            {
                final Bundle result = new Bundle();
                result.putString(AccountManager.KEY_ACCOUNT_NAME, "Saamu"+account.name);
